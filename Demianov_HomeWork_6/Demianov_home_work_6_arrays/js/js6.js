...
let createString = function(stringElements) {
    const stringArray = [];
 ...
 const generate_id = () => {
    ...
    let idInit = '0000000000';
    let idInit2 = idInit.split('');
    let idInit3 = idInit2.reduce((prev, next) => prev + words[Math.floor(Math.random() * words.length)], "");
    return idInit3
}
